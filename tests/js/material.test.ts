...
import h_BN from "../../materials/BN-[Hexagonal_Boron_Nitride]-HEX_[P6%5Cmmm]_2D_[Monolayer]-[2dm-4991].json";
import Graphene from "../../materials/C-[Graphene]-HEX_[P6%5Cmmm]_2D_[Monolayer]-[2dm-3993].json";
