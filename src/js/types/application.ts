...
export type FlavorYAMLItem = Pick<FlavorSchema, "input" | "isDefault"> &
    PartialPick<FlavorSchema, RuntimeItemsFields> & {
        supportedApplicationVersions?: string;
    };

export type ExecutableYAMLItem = Pick<ExecutableSchema, "hasAdvancedComputeOptions" | "isDefault"> &
    PartialPick<ExecutableSchema, RuntimeItemsFields> & {
...
type ExecutableTreeItem = Pick<ExecutableSchema, RequiredExecutableFields> &
